...
<h5 style={{marginLeft:"60px"}}>Products</h5>
          ...
          <div  className='container'>
                    <div  className='row'>
                        {
                            api.map(({title,tags,thumbnail,price}) => {
                                return(
                ...
                <hr></hr>
                 ...
                 <p className="card-tags">{tags}</p>
                    ...
                    <a  href="#"  className="btn btn-primary"onClick={()=>{addcart({title,tags,thumbnail,price})}}>Add to cart</a>
                </div>
             </div>
